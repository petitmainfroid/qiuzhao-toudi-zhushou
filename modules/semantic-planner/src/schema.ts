...
export const AI_PLANNER_REQUEST_SCHEMA = Object.freeze(closedObject({
  ...
  defaultResume: closedObject({
    hasValue: { type: "boolean" },
    mimeType: { const: "application/pdf" }
  }, ["hasValue", "mimeType"])
}, ["schemaVersion", "runFlags", "fields", "profilePathCatalog", "defaultResume"]));
...
const collectionEmptyDecision = closedObject({
  kind: { const: "map_collection_empty" }, ref, profilePath
}, ["kind", "ref", "profilePath"]);
const mapDateRangeDecision = closedObject({
  kind: { const: "map_date_range" }, ref, startProfilePath: profilePath, endProfilePath: profilePath
}, ["kind", "ref", "startProfilePath", "endProfilePath"]);
const mapDateRangeStartDecision = closedObject({
  kind: { const: "map_date_range_start" }, ref, startProfilePath: profilePath
}, ["kind", "ref", "startProfilePath"]);
const uploadDefaultResumeDecision = closedObject({
  kind: { const: "upload_default_resume" }, ref
}, ["kind", "ref"]);
...
export const AI_DECISION_PROPOSAL_SCHEMA = Object.freeze(closedObject({
  ...
  decisions: {
    ...
    items: {
      oneOf: [
        mapDecision,
        mapDateRangeDecision,
        mapDateRangeStartDecision,
        missingDecision,
        manualDecision,
        reviewDecision,
        notApplicableDecision,
        repeatableDecision,
        collectionEmptyDecision,
        uploadDefaultResumeDecision
      ]
    }
  }
