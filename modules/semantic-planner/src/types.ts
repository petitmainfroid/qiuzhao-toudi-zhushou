...
export type AiFieldDecision =
  ...
  | { kind: "map_date_range"; ref: string; startProfilePath: string; endProfilePath: string }
  | { kind: "map_date_range_start"; ref: string; startProfilePath: string }
  ...
  | { kind: "upload_default_resume"; ref: string }
  | { kind: "ensure_repeatable"; ref: string; profilePath: string }
  | { kind: "map_collection_empty"; ref: string; profilePath: string };
