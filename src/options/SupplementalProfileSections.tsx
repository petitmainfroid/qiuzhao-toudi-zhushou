  ...
  return (
    <>
      <section className="form-card" id="campus">
        <SectionHeader index="10" icon={<UsersRound size={21} />} title="校园经历" description="在校职务和校园活动分开维护，便于不同招聘系统按自己的结构复用。" />
      ...
      <section className="form-card" id="certificates">
        <SectionHeader index="11" icon={<BadgeCheck size={21} />} title="证书信息" description="记录证书名称、获得时间和说明；证书附件不会被自动上传。" />
